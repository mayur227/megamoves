...
const DownloadAppModal = (props) => {
    ...
    return(
        <>
            <Modal title="Download Our Official App" centered width={650} footer={null} className='download-app-modal header-heading-style' open={isModalOpen} onCancel={handleCancel}>
